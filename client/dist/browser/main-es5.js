...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppHomeAdsCommercialCommercialComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAdminPanelAllAdsAllAdsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AllAdsComponent, [{
        ...
        key: "removeAds",
        value: function removeAds(id, index) {
          var _this9 = this;

          this.adsService.removeAds(id).subscribe(function (data) {
            console.log(data);

            _this9.allAds.splice(index, 1);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(AllHeadlinesComponent, [{
        ...
        value: function getAllHeadlines() {
          ...
          return this.headlineService.getAllHeadlines().subscribe(function (data) {
            ...
            _this10.allHeadlines = data['headlinesData'];
            console.log(_this10.allHeadlines);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        key: "toggleFiltered",
        value: function toggleFiltered(index) {
          var item = this.allFilteredHeadlines[index];
          item['isActive'] === false ? item['isActive'] = true : item['isActive'] = false;
        }
      }, {
        key: "deleteHeadlines",
        value: function deleteHeadlines(index, id) {
          ...
          return this.headlineService.deleteHeadlines(id).subscribe(function (data) {
            ...
            _this11.allHeadlines.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(AllNewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().subscribe(function (data) {
            ...
            _this13.allNews = data['newsData'];
            console.log(_this13.allNews);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function removeNews(index, newsID) {
          ...
          return this.newsService.deleteNews(newsID).subscribe(function (data) {
            ...
            _this14.allNews.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveCultureComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getCulture().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this15.allCulture = data['cultureData'];

            _this15.allCulture.map(function (item) {
              return item.isActive = false;
            });
          });
        }
        ...
        key: "toggleFiltered",
        value: function toggleFiltered(index) {
          var item = this.allFilteredCulture[index];
          item['isActive'] === false ? item['isActive'] = true : item['isActive'] = false;
        }
      }, {
        key: "deleteCulture",
        value: function deleteCulture(index, id) {
          ...
          return this.adminService.removeCulture(id).subscribe(function (data) {
            ...
            _this16.allCulture.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveEconomyComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getAllEconomy().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this18.allEconomy = data['economyData'];
          });
        }
      }, {
        key: "toggle",
        ...
        key: "toggleFiltered",
        value: function toggleFiltered(index) {
          var item = this.allFilteredEconomy[index];
          item['isActive'] === false ? item['isActive'] = true : item['isActive'] = false;
        }
      }, {
        key: "deleteEconomy",
        value: function deleteEconomy(index, id) {
          ...
          return this.adminService.removeEconomy(id).subscribe(function (data) {
            ...
            _this19.allEconomy.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveNewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            ...
            _this21.allNews = data['newsData'];
            console.log(_this21.allNews);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        key: "toggleFitered",
        value: function toggleFitered(index) {
          var item = this.allFilteredNews[index];
          item.isActive === false ? item.isActive = true : item.isActive = false;
        }
      }, {
        key: "removeNews",
        value: function removeNews(index, newsID) {
          ...
          return this.newsService.deleteNews(newsID).subscribe(function (data) {
            ...
            _this22.allNews.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemovePoliticsComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getAllPolitics().subscribe(function (data) {
            console.log(data);
            _this24.allPolitics = data['politicsData'];
          });
        }
      }, {
        key: "toggle",
        ...
        key: "toggleFiltered",
        value: function toggleFiltered(index) {
          var item = this.allFilteredPolitics[index];
          item['isActive'] === false ? item['isActive'] = true : item['isActive'] = false;
        }
      }, {
        key: "deletePolitics",
        value: function deletePolitics(index, id) {
          ...
          return this.adminService.removePolitics(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            ...
            _this25.allPolitics.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.events.subscribe(function (url) {
            _this27.router.url.includes('/admin') ? _this27.isAdminActive = true : _this27.isAdminActive = false;
          });
        }
      }, {
        key: "getAdminStatus",
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _image_lazy_load_image_lazy_load_module__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./image-lazy-load/image-lazy-load.module */
    "./src/app/image-lazy-load/image-lazy-load.module.ts");
    /* harmony import */


    var _home_ads_commercial_commercial_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./home/ads/commercial/commercial.component */
    "./src/app/home/ads/commercial/commercial.component.ts");
    /* harmony import */


    var ng2_social_share__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ng2-social-share */
    "./node_modules/ng2-social-share/src/ng2-social-share.js");
    /* harmony import */


    var ng2_social_share__WEBPACK_IMPORTED_MODULE_37___default =
    /*#__PURE__*/
    __webpack_require__.n(ng2_social_share__WEBPACK_IMPORTED_MODULE_37__); // import { JwSocialButtonsModule } from 'jw-angular-social-buttons';
      ...
      _createClass(CultureDetailsComponent, [{
        ...
        value: function getEconomyById() {
          ...
          return this.cultureSerice.getCultureById(this.cultureId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this28.cultures = [data];
            console.log(_this28.cultures);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(CultureComponent, [{
        ...
        value: function getAllCulture() {
          ...
          this.adminService.getCulture().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this29.allCulutre = data['cultureData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(EconomyDetailsComponent, [{
        ...
        value: function getEconomyById() {
          ...
          return this.economyService.getEconomyById(this.economyID).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this30.economies = [data];
            console.log(_this30.economies);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(EconomyComponent, [{
        ...
        value: function getAllEconomy() {
          ...
          this.adminService.getAllEconomy().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this31.allEconomy = data['economyData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
  ...
  function srcAppHeadlinesHeadlinesComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".button::-moz-focus-inner {\n  border: 0;\n  padding: 0;\n}\n\n.button {\n  display: inline-block;\n  *display: inline;\n  zoom: 1;\n  padding: 6px 20px;\n  margin: 0;\n  cursor: pointer;\n  border: 1px solid #bbb;\n  overflow: visible;\n  font: bold 13px arial, helvetica, sans-serif;\n  text-decoration: none;\n  white-space: nowrap;\n  color: #555;\n  outline: none;\n  background-color: #ddd;\n  -webkit-transition: background-color 0.2s ease-out;\n  transition: background-color 0.2s ease-out;\n  background-clip: padding-box;\n  /* Fix bleeding */\n  border-radius: 3px;\n  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.3), 0 2px 2px -1px rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3) inset;\n  text-shadow: 0 1px 0 rgba(255, 255, 255, 0.9);\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n\n.button:hover {\n  background-color: #eee;\n  color: #555;\n}\n\n.button:active {\n  background: #e9e9e9;\n  position: relative;\n  top: 1px;\n  text-shadow: none;\n  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.3) inset;\n}\n\n.button[disabled], .button[disabled]:hover, .button[disabled]:active {\n  border-color: #eaeaea;\n  background: #fafafa;\n  cursor: default;\n  position: static;\n  color: #999;\n  /* Usually, !important should be avoided but here it's really needed :) */\n  box-shadow: none !important;\n  text-shadow: none !important;\n}\n\n.button.large {\n  padding: 12px 30px;\n  text-transform: uppercase;\n}\n\n.button.large:active {\n  top: 2px;\n}\n\n.headlines {\n  border-radius: 0.5rem;\n  box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.7);\n  border: 2px solid #000000;\n  border-radius: 0.5rem;\n}\n\n.headlines__title h1 {\n  text-align: center;\n  font-family: \"Lora\", serif;\n  border-bottom: 2px solid #000000;\n  padding-bottom: 0.5rem;\n}\n\n.popular__title {\n  text-align: center;\n}\n\n.popular__title span {\n  color: #777777;\n  font-size: 0.875rem;\n}\n\n.popular__img__content {\n  width: 100%;\n  height: 18rem !important;\n}\n\n.popular__img__content img {\n  width: 100%;\n  height: 100%;\n  border-radius: 0.5rem;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n\n.popular__description {\n  -ms-hyphens: auto;\n  -webkit-hyphens: auto;\n  hyphens: auto;\n  word-wrap: break-word;\n}\n\n.popular__description h4 {\n  font-size: 1rem;\n  color: #000000;\n  font-weight: bold;\n  font-family: \"Lora\", serif;\n  cursor: pointer;\n}\n\n.popular__description span {\n  font-size: 1rem;\n  color: #777777;\n}\n\n.popular__description p {\n  font-size: 0.875rem;\n}\n\n.content-on-main {\n  width: 100%;\n  height: 8rem;\n}\n\n.content-on-main img {\n  width: 100%;\n  height: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n\n.headlines-title {\n  text-align: center;\n}\n\n.headlines-title h4 {\n  text-align: center;\n  font-family: \"Lora\", serif;\n  border-bottom: 2px solid #000000;\n  padding-bottom: 0.5rem;\n  font-size: 2rem !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(HeadlinesComponent, [{
        ...
        value: function getAllHeadlines() {
          ...
          return this.headlinesService.getAllHeadlines().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            if (_this33.router.url !== '/home') {
              _this33.allHeadlines = data['headlinesData'].reverse();
              console.log(_this33.allHeadlines);
              _this33.isShowAllHeadlinesActive = false;
            } else {
              var newsData = data['headlinesData'].reverse();

              if (newsData.length >= 8) {
                _this33.allHeadlines = [newsData[0], newsData[1], newsData[2], newsData[3], newsData[4], newsData[5], newsData[6], newsData[7]];
                _this33.isShowAllHeadlinesActive = true;
              } else {
                _this33.allHeadlines = newsData;
              }
  ...
  function srcAppHomeAdsAdsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".button::-moz-focus-inner {\n  border: 0;\n  padding: 0;\n}\n\n.button {\n  display: inline-block;\n  *display: inline;\n  zoom: 1;\n  padding: 6px 20px;\n  margin: 0;\n  cursor: pointer;\n  border: 1px solid #bbb;\n  overflow: visible;\n  font: bold 13px arial, helvetica, sans-serif;\n  text-decoration: none;\n  white-space: nowrap;\n  color: #555;\n  outline: none;\n  background-color: #ddd;\n  -webkit-transition: background-color 0.2s ease-out;\n  transition: background-color 0.2s ease-out;\n  background-clip: padding-box;\n  /* Fix bleeding */\n  border-radius: 3px;\n  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.3), 0 2px 2px -1px rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3) inset;\n  text-shadow: 0 1px 0 rgba(255, 255, 255, 0.9);\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n\n.button:hover {\n  background-color: #eee;\n  color: #555;\n}\n\n.button:active {\n  background: #e9e9e9;\n  position: relative;\n  top: 1px;\n  text-shadow: none;\n  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.3) inset;\n}\n\n.button[disabled], .button[disabled]:hover, .button[disabled]:active {\n  border-color: #eaeaea;\n  background: #fafafa;\n  cursor: default;\n  position: static;\n  color: #999;\n  /* Usually, !important should be avoided but here it's really needed :) */\n  box-shadow: none !important;\n  text-shadow: none !important;\n}\n\n.button.large {\n  padding: 12px 30px;\n  text-transform: uppercase;\n}\n\n.button.large:active {\n  top: 2px;\n}\n\n.ads__img__content {\n  width: 100%;\n  height: 10rem;\n}\n\n.ads__img__content img {\n  width: 100%;\n  height: 100%;\n  border-top-left-radius: 0.5rem;\n  border-top-right-radius: 0.5rem;\n}\n\n.ads__description {\n  background-color: #e8e8e88e;\n  border-radius: 0.5rem;\n}\n\n.ads__description h4 {\n  font-size: 1.3rem;\n  font-family: \"Lora\", serif;\n  font-weight: bold;\n  text-align: center;\n  letter-spacing: 0.1rem;\n}\n\n.ads__description p {\n  font-size: 0.875rem;\n  color: #777777;\n  width: 100%;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppHomeAdsCommercialCommercialComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".button::-moz-focus-inner {\n  border: 0;\n  padding: 0;\n}\n\n.button {\n  display: inline-block;\n  *display: inline;\n  zoom: 1;\n  padding: 6px 20px;\n  margin: 0;\n  cursor: pointer;\n  border: 1px solid #bbb;\n  overflow: visible;\n  font: bold 13px arial, helvetica, sans-serif;\n  text-decoration: none;\n  white-space: nowrap;\n  color: #555;\n  outline: none;\n  background-color: #ddd;\n  -webkit-transition: background-color 0.2s ease-out;\n  transition: background-color 0.2s ease-out;\n  background-clip: padding-box;\n  /* Fix bleeding */\n  border-radius: 3px;\n  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.3), 0 2px 2px -1px rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3) inset;\n  text-shadow: 0 1px 0 rgba(255, 255, 255, 0.9);\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n\n.button:hover {\n  background-color: #eee;\n  color: #555;\n}\n\n.button:active {\n  background: #e9e9e9;\n  position: relative;\n  top: 1px;\n  text-shadow: none;\n  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.3) inset;\n}\n\n.button[disabled], .button[disabled]:hover, .button[disabled]:active {\n  border-color: #eaeaea;\n  background: #fafafa;\n  cursor: default;\n  position: static;\n  color: #999;\n  /* Usually, !important should be avoided but here it's really needed :) */\n  box-shadow: none !important;\n  text-shadow: none !important;\n}\n\n.button.large {\n  padding: 12px 30px;\n  text-transform: uppercase;\n}\n\n.button.large:active {\n  top: 2px;\n}\n\n.ads {\n  background-color: #e8e8e88e;\n  border-radius: 0.5rem;\n}\n\n.ads__img__content {\n  width: 100%;\n  height: 3.5rem;\n  border-radius: 0.5rem;\n  background-color: black;\n}\n\n.ads__img__content img {\n  width: 100%;\n  height: 100%;\n  border-radius: 5px;\n  -o-object-fit: cover;\n     object-fit: cover;\n  cursor: pointer;\n  opacity: 0.8;\n}\n\n.ads__img__content img:hover {\n  opacity: 1;\n  -webkit-transition: 0.4s;\n  transition: 0.4s;\n}\n\n.ads__description {\n  border-radius: 0.5rem;\n}\n\n.ads__description h4 {\n  font-size: 1.3rem;\n  font-family: \"Lora\", serif;\n  font-weight: bold;\n  text-align: center;\n  letter-spacing: 0.1rem;\n  border-bottom: 2px solid black;\n  padding-bottom: 0.7rem;\n}\n\n.ads__description p {\n  font-size: 0.875rem;\n  color: #777777;\n  width: 100%;\n}\n\n.ads__box__image {\n  width: 100%;\n  height: 7rem;\n}\n\n.ads__box__image__content:hover {\n  background: black;\n  -webkit-transition: 0.3s;\n  transition: 0.3s;\n}\n\n.ads__box__image img {\n  width: 100%;\n  height: 100%;\n  border-radius: 2px;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppHomeAdsCommercialCommercialComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CommercialComponent =
    /*#__PURE__*/
    function () {
      function CommercialComponent(adsService, router) {
      ...
      _createClass(CommercialComponent, [{
        ...
        value: function getAllAds() {
          ...
          this.adsService.getAllAds().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            // console.log(data);
            _this34.allAds = data['adsData'];
            console.log(_this34.allAds);
          }, function (err) {
            return console.log(err);
          });
        }
    ...
    CommercialComponent.ctorParameters = function () {
      return [{
        type: src_app_services_ads_service__WEBPACK_IMPORTED_MODULE_2__["AdsService"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]
    ...
    CommercialComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-commercial',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./commercial.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/home/ads/commercial/commercial.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./commercial.component.scss */
      "./src/app/home/ads/commercial/commercial.component.scss")).default]
    })], CommercialComponent);
    /***/
  },
      ...
      _createClass(CurrencyComponent, [{
        ...
        value: function getCurrencyRate() {
          ...
          return this.globalSerice.getCurrency().subscribe(function (data) {
            _this35.USD = data['usd']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this35.GBP = data['gbp']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this35.EURO = data['eur']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this35.RUB = data['rub']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(SliderComponent, [{
        ...
        value: function getHeadlines() {
          ...
          return this.headlinesService.getAllHeadlines().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this36.allHeadlineImages = data['headlinesData'].map(function (item) {
              return item;
            });
            _this36.images = _this36.allHeadlineImages.map(function (item) {
              return item;
            }).reverse();
            ;
          }, function (err) {
          ...
          var obs = new IntersectionObserver(function (entries) {
            entries.forEach(function (_ref) {
              ...
              if (isIntersecting) {
                ...
                obs.unobserve(_this38.el.nativeElement);
              }
            });
          });
    ...
    function () {
      ...
      _createClass(NewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            if (_this40.router.url !== '/home') {
              _this40.allNews = data['newsData'].reverse();
              console.log(_this40.allNews);

              _this40.result.emit(_this40.allNews.length);

              _this40.isShowAllNewsActive = false;
            } else {
              var newsData = data['newsData'].reverse();

              if (newsData.length >= 7) {
                _this40.allNews = [newsData[0], newsData[1], newsData[2], newsData[3], newsData[4], newsData[5]];
                _this40.isShowAllNewsActive = true;
              } else {
                _this40.allNews = newsData;
              }
      ...
      _createClass(PoliticsDetailsComponent, [{
        ...
        value: function getPoliticsById() {
          ...
          return this.politicsService.getPoliticsById(this.politicsID).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this41.politics = [data];
            console.log(_this41.politics);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(PoliticsComponent, [{
        ...
        value: function getAllPolitics() {
          ...
          this.adminService.getAllPolitics().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this42.allPoltics = data['politicsData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
  ...
  function srcAppServicesAdsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AdsService, [{
        ...
        key: "removeAds",
        value: function removeAds(id) {
          var url = "ads/".concat(id);
          return this.http.delete(url);
        }
      }]);
    ...
    function () {
      ...
      _createClass(NewsService, [{
        ...
        value: function getNews() {
          var url = 'http://167.172.172.153:8080/news';
          return this.http.get(url);
        }
      }, {
        key: "getNewsById",
