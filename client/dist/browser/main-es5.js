        ...
        value: function submitForm() {
          ...
          this.adminService.loginAdmin(this.adminForm.value).subscribe(function (data) {
            ...
            if (acessToken) {
              ...
              _this7.router.navigate(['/admin/add-news']);
            } else {
      ...
      _createClass(AllHeadlinesComponent, [{
        ...
        value: function getAllHeadlines() {
          ...
          return this.headlineService.getAllHeadlines().subscribe(function (data) {
            ...
            _this8.allHeadlines = data['headlinesData'];
            console.log(_this8.allHeadlines);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function deleteHeadlines(index, id) {
          ...
          return this.headlineService.deleteHeadlines(id).subscribe(function (data) {
            ...
            _this9.allHeadlines.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(AllNewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().subscribe(function (data) {
            ...
            _this11.allNews = data['newsData'];
            console.log(_this11.allNews);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function removeNews(index, newsID) {
          ...
          return this.newsService.deleteNews(newsID).subscribe(function (data) {
            ...
            _this12.allNews.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveCultureComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getCulture().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this13.allCulture = data['cultureData'];

            _this13.allCulture.map(function (item) {
              return item.isActive = false;
            });
          });
        }
        ...
        value: function deleteCulture(index, id) {
          ...
          return this.adminService.removeCulture(id).subscribe(function (data) {
            ...
            _this14.allCulture.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveEconomyComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getAllEconomy().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this16.allEconomy = data['economyData'];
          });
        }
      }, {
        key: "toggle",
        ...
        value: function deleteEconomy(index, id) {
          ...
          return this.adminService.removeEconomy(id).subscribe(function (data) {
            ...
            _this17.allEconomy.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemoveNewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            ...
            _this19.allNews = data['newsData'];
            console.log(_this19.allNews);
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function removeNews(index, newsID) {
          ...
          return this.newsService.deleteNews(newsID).subscribe(function (data) {
            ...
            _this20.allNews.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(RemovePoliticsComponent, [{
        ...
        value: function getAllCulture() {
          ...
          return this.adminService.getAllPolitics().subscribe(function (data) {
            console.log(data);
            _this22.allPolitics = data['politicsData'];
          });
        }
      }, {
        key: "toggle",
        ...
        value: function deletePolitics(index, id) {
          ...
          return this.adminService.removePolitics(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            ...
            _this23.allPolitics.splice(index, 1);
          }, function (err) {
            console.log(err);
          });
        }
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.events.subscribe(function (url) {
            _this25.router.url.includes('/admin') ? _this25.isAdminActive = true : _this25.isAdminActive = false;
          });
        }
      }, {
        key: "getAdminStatus",
      ...
      _createClass(CultureDetailsComponent, [{
        ...
        value: function getEconomyById() {
          ...
          return this.cultureSerice.getCultureById(this.cultureId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this26.cultures = [data];
            console.log(_this26.cultures);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(CultureComponent, [{
        ...
        value: function getAllCulture() {
          ...
          this.adminService.getCulture().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this27.allCulutre = data['cultureData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(EconomyDetailsComponent, [{
        ...
        value: function getEconomyById() {
          ...
          return this.economyService.getEconomyById(this.economyID).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this28.economies = [data];
            console.log(_this28.economies);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(EconomyComponent, [{
        ...
        value: function getAllEconomy() {
          ...
          this.adminService.getAllEconomy().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this29.allEconomy = data['economyData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(HeadlinesComponent, [{
        ...
        value: function getAllHeadlines() {
          ...
          return this.headlinesService.getAllHeadlines().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            if (_this31.router.url !== '/home') {
              _this31.allHeadlines = data['headlinesData'].reverse();
              console.log(_this31.allHeadlines);
              _this31.isShowAllHeadlinesActive = false;
            } else {
              var newsData = data['headlinesData'].reverse();

              if (newsData.length >= 8) {
                _this31.allHeadlines = [newsData[0], newsData[1], newsData[2], newsData[3], newsData[4], newsData[5], newsData[6], newsData[7]];
                _this31.isShowAllHeadlinesActive = true;
              } else {
                _this31.allHeadlines = newsData;
              }
      ...
      _createClass(CurrencyComponent, [{
        ...
        value: function getCurrencyRate() {
          ...
          return this.globalSerice.getCurrency().subscribe(function (data) {
            _this33.USD = data['usd']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this33.GBP = data['gbp']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this33.EURO = data['eur']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
            _this33.RUB = data['rub']['inverseRate'].toString().split('.')[0] + ',' + data['usd']['inverseRate'].toString().split('.')[1].toString().split('')[0];
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(SliderComponent, [{
        ...
        value: function getHeadlines() {
          ...
          return this.headlinesService.getAllHeadlines().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this34.allHeadlineImages = data['headlinesData'].map(function (item) {
              return item;
            });
            _this34.images = _this34.allHeadlineImages.map(function (item) {
              return item;
            }).reverse();
            ;
          }, function (err) {
          ...
          var obs = new IntersectionObserver(function (entries) {
            entries.forEach(function (_ref) {
              ...
              if (isIntersecting) {
                ...
                obs.unobserve(_this36.el.nativeElement);
              }
            });
          });
    ...
    function () {
      ...
      _createClass(NewsComponent, [{
        ...
        value: function getAllNews() {
          ...
          return this.newsService.getNews().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            if (_this38.router.url !== '/home') {
              _this38.allNews = data['newsData'].reverse();
              console.log(_this38.allNews);

              _this38.result.emit(_this38.allNews.length);

              _this38.isShowAllNewsActive = false;
            } else {
              var newsData = data['newsData'].reverse();

              if (newsData.length >= 7) {
                _this38.allNews = [newsData[0], newsData[1], newsData[2], newsData[3], newsData[4], newsData[5]];
                _this38.isShowAllNewsActive = true;
              } else {
                _this38.allNews = newsData;
              }
      ...
      _createClass(PoliticsDetailsComponent, [{
        ...
        value: function getPoliticsById() {
          ...
          return this.politicsService.getPoliticsById(this.politicsID).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            _this39.politics = [data];
            console.log(_this39.politics);
          }, function (err) {
            return console.log(err);
          });
        }
      ...
      _createClass(PoliticsComponent, [{
        ...
        value: function getAllPolitics() {
          ...
          this.adminService.getAllPolitics().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            console.log(data);
            _this40.allPoltics = data['politicsData'].reverse();
          }, function (err) {
            return console.log(err);
          });
        }
